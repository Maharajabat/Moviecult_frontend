  ...
  return (
    ...
    <div className="userprofile">
      ...
      <form action="" className="userform" onSubmit={handlesubmit}>
        ...
        <input type="text" value={username} id="username"  style={{textTransform:"none"}} onChange={(e)=>{setname(e.target.value);setfail(false);setsuccess(false);upd.disabled=false;
    upd.style.opacity="100%";}} required/>
        <label htmlFor="email">Email</label>
        <input type="email" value={email} id="email" style={{textTransform:"lowercase"}} onChange={(e)=>{setemail(e.target.value);setfail(false);setsuccess(false);upd.disabled=false;
    upd.style.opacity="100%";}} required />
        <label htmlFor="password">Password</label>
        <input type="password" value={password}  id="password"  style={{textTransform:"none"}} onChange={(e)=>{setpassword(e.target.value);setfail(false);setsuccess(false);upd.disabled=false;
    upd.style.opacity="100%";}} required/>
